 ...
 * @author zujeily
 */
public class AutosLujo extends Vehiculos{
    
    protected int CantidadPasajeros;

    public AutosLujo(String NumSerieMotor, String Marca, int Año, String Combustible, String Color, int CantidadPasajeros) {
